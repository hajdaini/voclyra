...
export const AppHome = ({
  ...
  <HomeView
    ...
    useLocalSpeechRuntime={settings.useLocalSpeechRuntime}
    useLocalImproveRuntime={settings.useLocalImproveRuntime}
    whisperModel={settings.useLocalSpeechRuntime ? settings.whisperModel : settings.remoteSpeechModel}
    llmModel={settings.useLocalImproveRuntime ? settings.llmModel : settings.remoteImproveModel}
